...
if(isset($_POST['delete_video'])){
   ...
   if($verify_video->rowCount() > 0){
      ...
      $message[] = 'Darslik o\'chirildi!';
   }else{
      $message[] = 'Darslik allaqachon o\'chirildi!';
   }
...
if(isset($_POST['delete_playlist'])){
   ...
   $message[] = 'Playlist o\'chirildi!';
      ...
      $message[] = 'Playlist allaqachon o\'chirildi!';
   }
}
...
<section class="contents">
   ...
   <h1 class="heading">Darsliklar</h1>
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_content.php?get_id=<?= $video_id; ?>" class="option-btn">Yangilash</a>
            <input type="submit" value="O'chirish" class="delete-btn" onclick="return confirm('Ushbu darslikni ochirishni istaysizmi?');" name="delete_video">
         </form>
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">Darslikni ko'rish</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">Darslik topilmadi!</p>';
      }
   }else{
      echo '<p class="empty">Iltimos, biror narsa qidiring!</p>';
   }
   ?>
...
<section class="playlists">
   ...
   <h1 class="heading">Pleylistlar</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Yangilash</a>
            <input type="submit" value="O'chirish" class="delete-btn" onclick="return confirm('Ushbu playlistni ochirishni istaysizmi?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">Pleylistni ko'rish</a>
      </div>
      <?php
         } 
      }else{
         echo '<p class="empty">Pleylist topilmadi!</p>';
      }}else{
         echo '<p class="empty">Iltimos, biror narsa qidiring!</p>';
      }
      ?>
