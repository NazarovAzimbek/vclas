...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Izoh allaqachon o\'chirildi!';
   }
   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <input type="submit" value="o'chirish" class="delete-btn" onclick="return confirm('Ushbu videoni o\'chirishni xohlaysizmi?');" name="delete_video">
         </div>
      </form>
   </div>
   <?php
      ...
      echo '<p class="empty">Hech qanday mazmun qo\'shilmagan! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">video qo\'shish</a></p>';
   }
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Ushbu izohni o\'chirishni xohlaysizmi?');">Izohni o\'chirish</button>
         </form>
      </div>
      <?php
       }
      }else{
         echo '<p class="empty">Hech qanday izoh qo\'shilmagan!</p>';
      }
      ?>
      </div>
