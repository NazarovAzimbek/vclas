...
if(isset($_POST['remove'])){
   if($user_id != ''){
      ...
      if($verify_likes->rowCount() > 0){
         ...
         $message[] = 'Sevimlilardan ochirildi!';
      }
   }else{
...
<section class="liked-videos">
   <h1 class="heading">Sevimli Videolar</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">Ko'rish</a>
            <input type="submit" value="O'chirish" class="inline-delete-btn" name="remove">
         </form>
      </div>
      <?php
            }
         }else{
            echo '<p class="empty">Darslik topilmadi topilmadi!</p>';         
         }
      }
   }else{
      echo '<p class="empty">Hech narsa yoq!</p>';
   }
   ?>
