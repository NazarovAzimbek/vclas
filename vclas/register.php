   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <input type="email" name="email" placeholder="Email manzilingizni kiriting" maxlength="50" required class="box">
         </div>
         <div class="col">
            ...
            <input type="password" name="cpass" placeholder="Parolingizni tasdiqlang" maxlength="20" required class="box">
         </div>
      </div>
      <p>Rasm tanlang <span>*</span></p>
      <input type="file" name="image" accept="image/*" required class="box">
      <p class="link">Hisobingiz bormi? <a href="login.php">Kirish</a></p>
