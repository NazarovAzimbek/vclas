...
<section class="courses">
   ...
   <h1 class="heading">Qidiruv natijalari</h1>
   ...
   <div class="box-container">
      ...
      <?php
         if(isset($_POST['search_course']) or isset($_POST['search_course_btn'])){
            ...
            $search_course = filter_var($search_course, FILTER_SANITIZE_STRING);  // Sanitizing the input
      ...
      <div class="box">
         ...
         <a href="playlist.php?get_id=<?= $course_id; ?>" class="inline-btn">Pleylistni ko'rish</a>
      </div>
      <?php
         }
      }else{
         echo '<p class="empty">Kurslar topilmadi!</p>';
      }
      }else{
