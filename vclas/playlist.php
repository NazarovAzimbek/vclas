...
<section class="playlist">
   ...
   <h1 class="heading">Pleylist tafsilotlari</h1>
   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>Saqlangan</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>Pleylistni saqlash</span></button>
            <?php
               }
            ?>
         </form>
      ...
      <?php
            ...
            echo '<p class="empty">Ushbu playlist topilmadi!</p>';
         }  
      ?>
...
<section class="videos-container">
   ...
   <h1 class="heading">Playlist Videolari</h1>
   ...
   <div class="box-container">
      ...
      <?php
            ...
            echo '<p class="empty">Hozircha video qoshilmagan!</p>';
         }
      ?>
