...
if(isset($_POST['update'])){
   ...
   if(!empty($thumb)){
      if($thumb_size > 2000000){
         $message[] = 'Rasmn hajmi juda katta!';
      }else{
...
<section class="video-form">
   ...
   <h1 class="heading">Darslikni yangilash</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Holatni yangilash <span>*</span></p>
      <select name="status" class="box" required>
         <option value="<?= $fecth_videos['status']; ?>" selected><?= $fecth_videos['status']; ?></option>
         <option value="active">faol</option>
         <option value="deactive">faol emas</option>
      </select>
      <p>Nomini yangilash <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="video nomini kiriting" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>Tavsifni yangilash <span>*</span></p>
      <textarea name="description" class="box" required placeholder="tavsif yozing" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>Pleylistni yangilash</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--playlist tanlash--</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>Hali playlist yaratilmagan!</option>';
         }
         ?>
      </select>
      ...
      <p>Videoni yangilash</p>
      <input type="file" name="video" accept="video/*" class="box">
      <input type="submit" value="Darslikni yangilash" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">Darslikni ko'rish</a>
         <input type="submit" value="Darslikni o'chirish" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">Video topilmadi! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Video qo\'shish</a></p>';
      }
   ?>
