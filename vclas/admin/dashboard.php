...
<section class="dashboard">
   ...
   <h1 class="heading">Bosh menyu</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="profile.php" class="btn">Profilni ko'rish</a>
      </div>

      <div class="box">
         <h3><?= $total_contents; ?></h3>
         <p>Jami darsliklar</p>
         <a href="add_content.php" class="btn">Yangi darslik qo'shish</a>
      </div>

      <div class="box">
         <h3><?= $total_playlists; ?></h3>
         <p>Jami pleylister</p>
         <a href="add_playlist.php" class="btn">Yangi pleylister qo'shish</a>
      </div>
